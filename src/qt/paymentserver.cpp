...
const QString BITCOIN_IPC_PREFIX("atom:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click atom: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start atom: click-to-pay handler");
    else
...
{
    // clicking on atom: URLs creates FileOpen events on the Mac:
